...
typedef struct {
  ...
  real_T Memory_b;                     /* '<S21>/Memory' */
  real_T Memory_m;                     /* '<S20>/Memory' */
  ...
  real_T Sum_i;                        /* '<S21>/Sum' */
  real_T Sum_l;                        /* '<S22>/Sum' */
  real_T Sum_ig;                       /* '<S23>/Sum' */
  real_T Sum_j;                        /* '<S24>/Sum' */
  real_T Sum2;                         /* '<S35>/Sum2' */
  real_T Sum3;                         /* '<S35>/Sum3' */
  uint16_T smallchange;                /* '<S19>/small change' */
  uint16_T smallchange_p;              /* '<S18>/small change' */
  uint8_T Sum_c;                       /* '<S18>/Sum' */
  uint8_T Sum_n;                       /* '<S19>/Sum' */
  boolean_T DataTypeConversion2;       /* '<S23>/Data Type Conversion2' */
  boolean_T DataTypeConversion2_h;     /* '<S21>/Data Type Conversion2' */
  boolean_T DataTypeConversion2_o;     /* '<S20>/Data Type Conversion2' */
  boolean_T Resetintegrator;           /* '<Root>/Reset integrator' */
  boolean_T DataTypeConversion2_m;     /* '<S24>/Data Type Conversion2' */
  boolean_T DataTypeConversion2_e;     /* '<S22>/Data Type Conversion2' */
  boolean_T GameController_o2[32];     /* '<S5>/Game Controller' */
} B_heli_q8_T;
...
typedef struct {
  ...
  real_T Memory_PreviousInput_d;       /* '<S20>/Memory' */
  ...
  struct {
    void *LoggedData;
  } Integratorreset_PWORK;             /* '<Root>/Integrator reset?' */
  ...
  struct {
    void *LoggedData;
  } Estimatorenabled_PWORK;            /* '<S5>/Estimator enabled' */

  struct {
    void *LoggedData;
  } LQRdisabled_PWORK;                 /* '<S5>/LQR disabled' */

  struct {
    void *LoggedData;
  } LQRintegratorenabled_PWORK;        /* '<S5>/LQR integrator enabled' */

  struct {
    void *LoggedData;
  } Motorsdisabled_PWORK;              /* '<S5>/Motors disabled' */

  struct {
    void *LoggedData;
  } Travelregulatorenabled_PWORK;      /* '<S5>/Travel regulator enabled' */
  ...
  struct {
    void *LoggedData;
  } XCtrlGainScope1_PWORK;             /* '<S5>/XCtrlGain: Scope1' */
  ...
  struct {
    void *LoggedData;
  } YCtrlGainScope2_PWORK;             /* '<S5>/YCtrlGain: Scope2' */

  struct {
    void *LoggedData;
  } sliders_PWORK;                     /* '<S5>/sliders' */

  struct {
    void *LoggedData;
  } Integratorelevation_PWORK;         /* '<S35>/Integrator  elevation' */

  struct {
    void *LoggedData;
  } IntegratorPitch_PWORK;             /* '<S35>/Integrator Pitch ' */
  ...
  boolean_T DelayInput1_DSTATE_e;      /* '<S26>/Delay Input1' */
  boolean_T DelayInput1_DSTATE_b;      /* '<S27>/Delay Input1' */
  boolean_T DelayInput1_DSTATE_a;      /* '<S28>/Delay Input1' */
  boolean_T DelayInput1_DSTATE_i;      /* '<S29>/Delay Input1' */
  boolean_T DelayInput1_DSTATE_m;      /* '<S30>/Delay Input1' */
  boolean_T DelayInput1_DSTATE_es;     /* '<S31>/Delay Input1' */
  boolean_T DelayInput1_DSTATE_l;      /* '<S32>/Delay Input1' */
  boolean_T DelayInput1_DSTATE_n;      /* '<S33>/Delay Input1' */
  uint8_T Memory_PreviousInput_mv;     /* '<S19>/Memory' */
  uint8_T Memory_PreviousInput_gj;     /* '<S18>/Memory' */
} DW_heli_q8_T;
...
typedef struct {
  ...
  real_T x_hat_CSTATE[6];              /* '<S11>/x_hat' */
  real_T Gamma_CSTATE;                 /* '<S35>/Gamma' */
  real_T Zeta_CSTATE;                  /* '<S35>/Zeta' */
} X_heli_q8_T;
...
typedef struct {
  ...
  boolean_T x_hat_CSTATE[6];           /* '<S11>/x_hat' */
  boolean_T Gamma_CSTATE;              /* '<S35>/Gamma' */
  boolean_T Zeta_CSTATE;               /* '<S35>/Zeta' */
} XDis_heli_q8_T;

/* Zero-crossing (trigger) state */
typedef struct {
  ZCSigState x_hat_Reset_ZCE;          /* '<S11>/x_hat' */
  ZCSigState Gamma_Reset_ZCE;          /* '<S35>/Gamma' */
  ZCSigState Zeta_Reset_ZCE;           /* '<S35>/Zeta' */
} PrevZCX_heli_q8_T;
...
struct P_heli_q8_T_ {
  real_T A_p4p2[36];                   /* Variable: A_p4p2
                                        * Referenced by: '<S11>/A'
                                        */
  real_T B_p4p2[12];                   /* Variable: B_p4p2
                                        * Referenced by: '<S11>/B'
                                        */
  real_T C_p4p2[18];                   /* Variable: C_p4p2
                                        * Referenced by: '<S11>/C'
                                        */
  ...
  real_T Joystick_gain_y;              /* Variable: Joystick_gain_y
                                        ...
                                        */
  real_T K_p3p2[6];                    /* Variable: K_p3p2
                                        * Referenced by: '<S36>/K * x'
                                        */
  real_T K_p3p3[10];                   /* Variable: K_p3p3
  ...
  real_T L[18];                        /* Variable: L
                                        * Referenced by: '<S11>/L'
                                        */
  real_T P_p3p2[4];                    /* Variable: P_p3p2
                                        * Referenced by: '<S37>/P * r'
                                        */
  real_T P_p3p3[4];                    /* Variable: P_p3p3
                                        * Referenced by: '<S39>/P * r'
                                        */
  real_T V_zero_offset;                /* Variable: V_zero_offset
  ...
  boolean_T HILInitialize_set_pwm_params__f;/* Mask Parameter: HILInitialize_set_pwm_params__f
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T Incx_vinit;                /* Mask Parameter: Incx_vinit
                                        * Referenced by: '<S25>/Delay Input1'
                                        */
  boolean_T Subx_vinit;                /* Mask Parameter: Subx_vinit
                                        * Referenced by: '<S26>/Delay Input1'
                                        */
  boolean_T Incx_vinit_e;              /* Mask Parameter: Incx_vinit_e
                                        * Referenced by: '<S27>/Delay Input1'
                                        */
  boolean_T Subx_vinit_e;              /* Mask Parameter: Subx_vinit_e
                                        * Referenced by: '<S28>/Delay Input1'
                                        */
  boolean_T Incx_vinit_f;              /* Mask Parameter: Incx_vinit_f
                                        * Referenced by: '<S29>/Delay Input1'
                                        */
  boolean_T Incx_vinit_p;              /* Mask Parameter: Incx_vinit_p
                                        * Referenced by: '<S30>/Delay Input1'
                                        */
  boolean_T Incx_vinit_g;              /* Mask Parameter: Incx_vinit_g
                                        * Referenced by: '<S31>/Delay Input1'
                                        */
  boolean_T Incx_vinit_c;              /* Mask Parameter: Incx_vinit_c
                                        * Referenced by: '<S32>/Delay Input1'
                                        */
  boolean_T Incx_vinit_eo;             /* Mask Parameter: Incx_vinit_eo
                                        * Referenced by: '<S33>/Delay Input1'
                                        */
  real_T K_ed_Gain;                    /* Expression: 12
                                        * Referenced by: '<S10>/K_ed'
                                        */
  real_T Travelrate_Gain;              /* Expression: pi/180
                                        * Referenced by: '<Root>/Travel rate'
                                        */
  real_T Constant_Value;               /* Expression: 0
                                        * Referenced by: '<Root>/Constant'
                                        */
  real_T Memory_X0;                    /* Expression: 15
                                        * Referenced by: '<S23>/Memory'
                                        */
  real_T Constant_Value_k;             /* Expression: 2
                                        * Referenced by: '<S23>/Constant'
                                        */
  real_T Memory_X0_p;                  /* Expression: 15
                                        * Referenced by: '<S21>/Memory'
                                        */
  real_T Constant_Value_b;             /* Expression: 2
                                        * Referenced by: '<S21>/Constant'
                                        */
  real_T Memory_X0_l;                  /* Expression: 15
  ...
  real_T Gain_Gain_a;                  /* Expression: 180/pi
                                        ...
                                        */
  real_T u2degoffset_Value;            /* Expression: 0.5271
  ...
  real_T Integrator_LowerSat;          /* Expression: -inf
                                        * Referenced by: '<S10>/Integrator'
                                        */
  real_T Elevation_Gain;               /* Expression: pi/180
                                        * Referenced by: '<Root>/Elevation'
                                        */
  real_T Memory_X0_j;                  /* Expression: 16
  ...
  real_T Gainy_Gain;                   /* Expression: 10/9
                                        ...
                                        */
  real_T Invert_Y_Value;               /* Expression: -1
                                        * Referenced by: '<S5>/Invert_Y'
                                        */
  real_T K_ep_Gain;                    /* Expression: 15
                                        * Referenced by: '<S10>/K_ep'
                                        */
  real_T x_hat_IC;                     /* Expression: 0
                                        * Referenced by: '<S11>/x_hat'
                                        */
  real_T Elevrate_Gain;                /* Expression: pi/180
  ...
  real_T Gainx_Gain;                   /* Expression: 10/9
                                        ...
                                        */
  real_T Invert_X_Value;               /* Expression: -1
                                        * Referenced by: '<S5>/Invert_X'
                                        */
  real_T Pitch_Gain;                   /* Expression: pi/180
                                        * Referenced by: '<Root>/Pitch'
                                        */
  real_T Pitchrate_Gain;               /* Expression: pi/180
  ...
  real_T Zeta_IC;                      /* Expression: 0
                                        ...
                                        */
  real_T Memory_X0_f;                  /* Expression: 15
                                        * Referenced by: '<S22>/Memory'
                                        */
  real_T Constant_Value_bf;            /* Expression: 2
  ...
  uint16_T GameController_BufferSize;  /* Computed Parameter: GameController_BufferSize
                                        ...
                                        */
  uint8_T Memory_X0_e;                 /* Computed Parameter: Memory_X0_e
                                        * Referenced by: '<S19>/Memory'
                                        */
  uint8_T Memory_X0_jd;                /* Computed Parameter: Memory_X0_jd
  ...
  boolean_T GameController_Enabled;    /* Computed Parameter: GameController_Enabled
                                        * Referenced by: '<S5>/Game Controller'
                                        */
  uint8_T smallchange_Gain;            /* Computed Parameter: smallchange_Gain
                                        * Referenced by: '<S19>/small change'
                                        */
  uint8_T smallchange_Gain_n;          /* Computed Parameter: smallchange_Gain_n
 ...
 * '<S3>'   : 'heli_q8/Estimator'
 * '<S4>'   : 'heli_q8/Heli 3D'
 * '<S5>'   : 'heli_q8/Joystick'
 * '<S6>'   : 'heli_q8/LQR'
 * '<S7>'   : 'heli_q8/Pitch controller'
 * '<S8>'   : 'heli_q8/Subsystem'
 * '<S9>'   : 'heli_q8/Travel controller'
 * '<S10>'  : 'heli_q8/Elevation controller/Elevation controller'
 * '<S11>'  : 'heli_q8/Estimator/Estimator'
 ...
 * '<S18>'  : 'heli_q8/Joystick/Detect trimming x (button 4//6)'
 * '<S19>'  : 'heli_q8/Joystick/Detect trimming y1 (button 3//5)'
 * '<S20>'  : 'heli_q8/Joystick/Toggle Estimator (button 9)'
 * '<S21>'  : 'heli_q8/Joystick/Toggle LQR (button 7)'
 * '<S22>'  : 'heli_q8/Joystick/Toggle LQR - integrator (button 8)'
 * '<S23>'  : 'heli_q8/Joystick/Toggle Motor (button 1)'
 * '<S24>'  : 'heli_q8/Joystick/Toggle Travel Regulator (button 2)'
 * '<S25>'  : 'heli_q8/Joystick/Detect trimming x (button 4//6)/Inc x'
 * '<S26>'  : 'heli_q8/Joystick/Detect trimming x (button 4//6)/Sub x'
 * '<S27>'  : 'heli_q8/Joystick/Detect trimming y1 (button 3//5)/Inc x'
 * '<S28>'  : 'heli_q8/Joystick/Detect trimming y1 (button 3//5)/Sub x'
 * '<S29>'  : 'heli_q8/Joystick/Toggle Estimator (button 9)/Inc x'
 * '<S30>'  : 'heli_q8/Joystick/Toggle LQR (button 7)/Inc x'
 * '<S31>'  : 'heli_q8/Joystick/Toggle LQR - integrator (button 8)/Inc x'
 * '<S32>'  : 'heli_q8/Joystick/Toggle Motor (button 1)/Inc x'
 * '<S33>'  : 'heli_q8/Joystick/Toggle Travel Regulator (button 2)/Inc x'
 * '<S34>'  : 'heli_q8/LQR/LQR_p3p2'
 * '<S35>'  : 'heli_q8/LQR/LQR_p3p3'
 * '<S36>'  : 'heli_q8/LQR/LQR_p3p2/K * x'
 * '<S37>'  : 'heli_q8/LQR/LQR_p3p2/P * r'
 * '<S38>'  : 'heli_q8/LQR/LQR_p3p3/K * x'
 * '<S39>'  : 'heli_q8/LQR/LQR_p3p3/P * r'
 */
